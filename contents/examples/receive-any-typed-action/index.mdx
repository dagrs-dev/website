---
title: Receive Any & Broadcast & Typed Action
description: Use `recv_any` and `broadcast` to simplify the process of sending & receiving packets, and use typed action to limit the type of package.
---

This example shows how to use `recv_any` and `broadcast` to simplify the process of sending & receiving packets, and use typed action to limit the type of package.
...
```rust showLineNumbers {24,35,53,66,87,97}
