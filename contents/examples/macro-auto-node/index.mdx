---
title: Macro `auto_node`
description:  The procedural macro `auto_node` simplifies the implementation of `Node` trait for custom types. It works on structs except tuple structs.
---

```rust showLineNumbers {5-6,8-13,15-16}
use std::sync::Arc;
